...
from games.planet_x.scenes import Intro, WormholeAppeared, WormholeSucks, Level1, Level2, Level3
...
class PlanetX(Controller):
    ...
    def init(self):
        self.scenes = [Intro, WormholeAppeared, WormholeSucks, Level1, Level2, Level3]
